...
btn.addEventListener('click', function() {
    ...
    tablica_pierwszej_odpowiedzi_gracza [4] = document.querySelector('input[name="pierwszaodpowiedz_pole5"]').value;
    ...
    tablica_drugiej_odpowiedzi_gracza [0] = document.querySelector('input[name="drugaodpowiedz_pole1"]').value;
    tablica_drugiej_odpowiedzi_gracza [1] = document.querySelector('input[name="drugaodpowiedz_pole2"]').value;
    tablica_drugiej_odpowiedzi_gracza [2] = document.querySelector('input[name="drugaodpowiedz_pole3"]').value;
    tablica_drugiej_odpowiedzi_gracza [3] = document.querySelector('input[name="drugaodpowiedz_pole4"]').value;
    tablica_drugiej_odpowiedzi_gracza [4] = document.querySelector('input[name="drugaodpowiedz_pole5"]').value;
    ...
    tablica_trzeciej_odpowiedzi_gracza [5] = document.querySelector('input[name="trzeciaodpowiedz_pole6"]').value;
    tablica_trzeciej_odpowiedzi_gracza [6] = document.querySelector('input[name="trzeciaodpowiedz_pole7"]').value;
    tablica_trzeciej_odpowiedzi_gracza [7] = document.querySelector('input[name="trzeciaodpowiedz_pole8"]').value;
    ...
    tablica_czwartej_odpowiedzi_gracza [3] = document.querySelector('input[name="czwartaodpowiedz_pole4"]').value;
    ...
    tablica_piatej_odpowiedzi_gracza [6] = document.querySelector('input[name="piataodpowiedz_pole7"]').value;
    tablica_piatej_odpowiedzi_gracza [7] = document.querySelector('input[name="piataodpowiedz_pole8"]').value;
    tablica_piatej_odpowiedzi_gracza [8] = document.querySelector('input[name="piataodpowiedz_pole9"]').value;
    ...
    {
        var twoja_odpowiedz2 = tablica_drugiej_odpowiedzi_gracza_Duze_Litery[1];
    ...
    {
        var twoja_odpowiedz3 = tablica_trzeciej_odpowiedzi_gracza_Duze_Litery[5];
    ...
    {
        var twoja_odpowiedz4 = tablica_czwartej_odpowiedzi_gracza_Duze_Litery[3];
    ...
    {
        var twoja_odpowiedz5 = tablica_piatej_odpowiedzi_gracza_Duze_Litery[2];
    ...
    {
        var twoja_odpowiedz6 = tablica_szostej_odpowiedzi_gracza_Duze_Litery[2];
